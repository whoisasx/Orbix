...
export const Ethereum = () => {
	...
	const handleAddWallet = () => {
		...
		try {
			...
			toast.success(`Ethereum wallet ${len + 1} created successfully!`);
		} catch (error) {
	...
	return (
		<section className="relative">
			{ethereums.length === 0 ? (
				...
				>
					<div className="w-20 h-20 mx-auto bg-linear-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6">
						<SiEthereum className="w-10 h-10 text-white" />
					</div>
					...
					<div className="flex items-center justify-between mb-8">
						<div className="flex items-center gap-3">
							<div className="w-12 h-12 bg-linear-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center">
								<SiEthereum className="w-6 h-6 text-white" />
							</div>
							<div>
					...
					>
						...
						>
							...
							<p className="text-gray-700 dark:text-gray-300 mb-6">
								...
								{ethereums.length} Ethereum wallets? Make sure
